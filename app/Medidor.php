...
class Medidor extends Model{
    ...
    public static function consultaSQL($todos){
        ...
        ->select('abonados.id', 'abonados.cedula', 'abonados.nombre', 'abonados.apellido1',
        'abonados.apellido2', 'medidores.id as medidor', 'medidores.estado', 'medidores.idTipoDeMedidor', 'tipo_de_medidores.nombre as tipo');
        if (!$todos) {
